...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:SqlDataSource ID="SdsMemoName" runat="server" ConnectionString="<%$ ConnectionStrings:ConnString %>" SelectCommand="SELECT [Name], [Num] FROM [Memos]"></asp:SqlDataSource>
            <br />
