...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:HyperLink ID="LnkMicrosoft" NavigateUrl="https://www.microsoft.com" Text="마이크로소프트" runat="server" />

            <asp:Image ID="ImgChange" runat="server" ImageUrl="~/images/aaa.png" />
